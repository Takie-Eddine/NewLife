            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('admin.edit food')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                        <!--begin::Form-->
                        <form class="form" action="{{route('admin.foods.update',$food->id)}}" method="POST" enctype="multipart/form-data" id="kt_subscriptions_create_new">
                            @csrf
                            <!--begin::Card-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex flex-column mb-15 fv-row">
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input class="form-control form-control-solid" name="date" value="{{$food->date}}"  placeholder="{{__('admin.pick date')}}" id="kt_datepicker_3"/>
                                                            ...
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <select class="form-select" name="type" data-placeholder="Select a Type" data-kt-ecommerce-catalog-add-category="condition_type">
                                                                            <option value="breakfast"{{$type->type == 'breakfast' ? 'selected' : null}}>{{__('admin.breakfast')}}</option>
                                                                            <option value="lunch"{{$type->type == 'lunch' ? 'selected' : null}}>{{__('admin.lunch')}}</option>
                                                                            <option value="dinner"{{$type->type == 'dinner' ? 'selected' : null}}>{{__('admin.dinner')}}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="inner-repeater">
                                                                        <div data-repeater-list="meals" class="mb-5">
                                                                            @forelse ($type->meals as $meal)
                                                                                <div data-repeater-item>
                                                                                    ...
                                                                                    <div class="input-group pb-3">
                                                                                        <input type="text" class="form-control" placeholder="{{__('admin.enter meal name')}}" name="name" value="{{$meal->name}}" />
                                                                                    ...
                                                                                    <div class="input-group pb-3">
                                                                                        <textarea class="form-control form-control-solid rounded-3" placeholder="{{__('admin.enter meal description')}}" rows="4" name="description">{{$meal->description}}</textarea>
                                                                                        <button class="border border-secondary btn btn-icon btn-flex btn-light-danger" data-repeater-delete type="button">
                                                                                            <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                                                        </button>
                                                                                    </div>
                            ...
                            <div class="mb-0">
                                <button type="submit" class="btn btn-primary" id="kt_subscriptions_create_button">
                                    ...
                                    <span class="indicator-label">{{__('admin.update food')}}</span>
                                    <!--end::Indicator label-->
