                        ...
                        <div class="col-md-6 col-xxl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    @if ($participant->profile->first_name)
                                        <a href="{{route('admin.participants.view',$participant->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$participant->profile->first_name}} {{$participant->profile->last_name}}</a>
                                    @else
                                        <a href="{{route('admin.participants.view',$participant->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$participant->name}}</a>
                                    @endif
