                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @forelse ($facilities as $facility)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.facilities.view',$facility->id)}}"  class="text-gray-800 text-hover-primary mb-1">{{$facility->name}}</a>
                                        </td>
                                        <td>
                                            <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$facility->description}}</a>
                                        </td>
                                        <td>{{$facility->type}}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7">No facility defined.</td>
                                </tr>
                                @endforelse
