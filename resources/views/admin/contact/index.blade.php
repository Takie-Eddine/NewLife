        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{__('admin.contact list')}}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="card-header pt-7" id="kt_contacts_list_header">
                                ...
                                <form class="d-flex align-items-center position-relative w-100 m-0" action="{{URL::current()}}" method="GET">
                                    {{-- <div class="d-flex align-items-center position-relative my-1"> --}}
                                        ...
                                        <input type="text" name="keyword" value="{{ old('keyword', request()->input('keyword')) }}"  data-kt-customer-table-filter="search" class="form-control form-control-solid ps-13" placeholder="{{__('admin.search contacts')}}" />
                                    {{-- </div> --}}
                                </form>
                                <!--end::Form-->
                            </div>
                                    ...
                                    @forelse ($admins as $admin)
                                        <div class="d-flex flex-stack py-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-4">
                                                    <a href="" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">{{$admin->name}}</a>
