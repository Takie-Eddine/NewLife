            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{__('admin.add plan')}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                        <!--begin::Form-->
                        <form class="form" action="{{route('admin.plans.store')}}" method="POST" enctype="multipart/form-data" id="kt_subscriptions_create_new">
                            @csrf
                            <!--begin::Card-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex flex-column mb-15 fv-row">
                                        ...
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input class="form-control form-control-solid rounded-3" placeholder="{{__('admin.enter plan name')}}" name="name" value="{{old('name')}}"/>
                                        </div>
                                        <!--end::Label-->
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <textarea class="form-control form-control-solid rounded-3" placeholder="{{__('admin.enter plan description')}}" rows="4" name="description">{{old('description')}}</textarea>
                                        </div>
                                        <div class="d-flex flex-column mb-10 fv-row">
                                            ...
                                            <select name="program" aria-label="Select a Program"  data-control="select2" data-placeholder="{{__('admin.select a program')}}"  class="form-select form-select-solid fw-bold">
                                                ...
                                                <option value="{{$program->id}}"{{old('program') == $program->id ? 'selected' : null}}>{{$program->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                            ...
                            <div class="mb-0">
                                <button type="submit" class="btn btn-primary" id="kt_subscriptions_create_button">
                                    ...
                                    <span class="indicator-label">{{__('admin.create plan')}}</span>
                                    <!--end::Indicator label-->
