                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-45px symbol-circle">
                                                    <img class="symbol-label bg-light-danger text-danger fs-6 fw-bolder" src="{{asset('images/participant/')}}" alt="">
                                                    <div class="symbol-badge bg-success start-100 top-100 border-4 h-8px w-8px ms-n2 mt-n2"></div>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                                <div class="ms-5">
                                                    <a href="" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">{{$conversation->reciver_email}}</a>
                                                    <div class="fw-semibold text-muted">{{$conversation->messages()->lastet()}}</div>
                                                </div>
                                                <!--end::Details-->
                                            </div>
                                            <!--end::Details-->
