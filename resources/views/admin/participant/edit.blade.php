    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form action="{{route('admin.participants.update',$participant->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select name="blood_type" aria-label="Select a Blood Type" data-control="select2" data-placeholder="Select a Blood Type..." class="form-select form-select-solid form-select-lg fw-semibold">
                                            ...
                                            @if ( $medical_info)
                                                ...
                                                <option value='A-'  @selected( $medical_info->blood_type == 'A-')>A-</option>
                                                <option value='B+'  @selected( $medical_info->blood_type == 'B+')>B+</option>
                                                <option value='B-'  @selected( $medical_info->blood_type == 'B-') >B-</option>
                                                <option value='AB+'  @selected( $medical_info->blood_type == 'AB+')>AB+</option>
                                                <option value='AB-'  @selected( $medical_info->blood_type == 'AB-')>AB-</option>
                                                <option value='O+'  @selected( $medical_info->blood_type == 'O+')>O+</option>
                                                <option value='O-'  @selected( $medical_info->blood_type == 'O-')>O-</option>
                                            @else
