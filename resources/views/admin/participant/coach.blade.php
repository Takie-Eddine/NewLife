        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <h3 class="text-gray-800 fw-bold my-2">{{__('admin.coaches')}}
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column py-9 px-5">
                                    ...
                                    @if ($coach->profile->first_name)
                                        <a href="{{route('admin.coaches.view',$coach->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$coach->profile->first_name}} {{$participant->profile->last_name}}</a>
                                    @else
                                        <a href="{{route('admin.coaches.view',$coach->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$coach->name}}</a>
                                    @endif
