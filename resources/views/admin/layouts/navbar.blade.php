                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        @if (Auth::user()->profile->photo)
                                        <img alt="user" src="{{asset('images/profile/'.Auth::user()->profile->photo)}}" />
                                    @else
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    @if (Auth::user()->profile->photo)
                                        <img alt="Logo" src="{{asset('images/profile/'.Auth::user()->profile->photo)}}" />
                                    @else
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('admin.profile')}}" class="menu-link px-5">{{__('navbar.my profile')}}</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        {{-- <div class="menu-item px-5">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{route('admin.profile.edit',Auth::user('admin')->id)}}" class="menu-link px-5">{{__('navbar.acount settings')}}</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a class="button-ajax menu-link px-5" href="{{ route('admin.logout') }}" data-action="{{ route('admin.logout') }}" data-method="post" data-csrf="{{ csrf_token() }}" data-reload="true" >{{__('navbar.sign out')}}</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
