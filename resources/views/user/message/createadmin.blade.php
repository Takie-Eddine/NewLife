            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('user.messages')}}" class="text-muted text-hover-primary">{{__('sidebar.inbox')}}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                    ...
                    <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <!--begin::Form-->
                                <form id="kt_inbox_compose_form" action="{{route('user.messages.storeadmin')}}" method="POST">
                                    @csrf
                                    <!--begin::Body-->
                                    <div class="d-block">
                                        <!--begin::To-->
                                        <input type="hidden" name="from" value="{{Auth::user('web')->email}}">
