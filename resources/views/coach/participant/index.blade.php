                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('coach.dashboard')}}" class="text-muted text-hover-primary">{{__('profile.home')}}</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Title-->
                    <h3 class="fw-bold my-2">{{__('admin.participants')}}
                    <span class="fs-6 fw-semibold ms-1">({{$participants->count()}})</span></h3>
                    <!--end::Title-->
                    <!--begin::Controls-->
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="type" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="{{__('user.select type')}}" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
                                                    ...
                                                    @forelse ($participants as $participant)
                                                        <option value="{{$participant->type}}" {{ old('type', request()->input('type')) == $participant->type ? 'selected' : '' }}>{{$participant->type}}</option>
                                                    @empty
                                    ...
                                    <div class="mb-5">
                                        <div class="symbol symbol-75px symbol-circle">
                                            @if ($participant->profile->photo)
                                                <img alt="Pic" src="{{asset('images/profile/'.$participant->profile->photo)}}" />
                                            @else
                                                <img alt="Pic" src="{{asset('images/no-image.png')}}" />
                                            @endif
                                        </div>
                                    </div>
                                    <a href="{{route('coach.participants.view',$participant->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$participant->profile->first_name.' '.$participant->profile->last_name }}</a>
