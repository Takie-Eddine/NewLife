    ...
    <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$coach->name}}</a>
                            <a href="#">
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('coach.profile') ? 'active' : ''}}" href="{{route('coach.profile')}}">{{__('admin.overview')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{request()->routeIs('coach.profile.edit') ? 'active' : ''}}" href="{{route('coach.profile.edit',$coach->id)}}">{{__('admin.settings')}}</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            {{-- <li class="nav-item mt-2">
