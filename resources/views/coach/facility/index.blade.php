        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{{__('coach.facility')}}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex flex-center flex-column p-9">
                                    <div class="mb-5">
                                        <div class="symbol symbol-75px symbol">
                                            @if ($facility->images[0]->name)
                                                <img alt="Pic" src="{{asset('images/facility/'.$facility->images[0]->name)}}" />
                                            @else
                                                <img alt="Pic" src="{{asset('images/no-image.png')}}" />
                                            @endif
                                        </div>
                                    </div>
                                    <a href="{{route('coach.facilities.view',$facility->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{$facility->name }}</a>
                                    <div class="fw-semibold text-gray-400 mb-6">{{$facility->type}}</div>
